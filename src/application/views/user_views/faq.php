                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>Como realizo o cadastro?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p> Passo 1: Adicione seu e-mail, esse e-mail será importante para atualizações e informações sobre a sua conta. Adicione seu usuário do Instagram. Lembre-se de não usar o “@”. Adicione sua senha. Você deve adicionar a mesma senha do Instagram.
                                            <br>Passo 2: Adicione seus dados de pagamento. Se houver erro durante o processamento de seus dados, entre em contato com nossa equipe de atendimento.
                                            <br>Passo 3: Clique em ASSINAR e comece a ser feliz! :) Após clicar em ASSINAR AGORA, você será direcionado para a página de cadastro de perfis de referência. Nessa página você deve selecionar 3 perfis de referência que podem ser deletados em seguida caso você deseje..
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>Como aumentar a visibilidade da minha marca?</h4>
                                    </div>
                                    <div class="accord-content">
...
‌                                           <br>Indicamos que o assinante teste, pelo menos, o 1º mês pois o resultado vem ao longo dos dias. Ao ativar o módulo de Mais Vissibilidade, os usuários vão interagindo com sua conta e seguindo de volta, afinal eles são pessoas reais interessadas no seu conteúdo. Você pode assinar e testar por 2 dias sem pagar nada, acesse www.doorig.com.
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>Qual é a diferência entre os planos do módulo de visibilidade?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>O que diferem os planos é a velocidade que cada um trabalha. As metas de ações diárias por plano são:
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        <i class="left-num border">04</i>
                                        <h4>Qué devo fazer quando tenho que Verificar a conta da minha marca?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>
                           ...
                           <div class="col-md-6 col-sm-12">
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>O que significa UNFOLLOW TOTAL / UNFOLLOW NORMAL?</h4>
                                    </div>
                                    <div class="accord-content">
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>O que significa SEGUIR SEMPRE e NUNCA SEGUIR?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        <i class="left-num border">07</i>
                                        <h4>Tenho privacidade com meus dados do cartão?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        <i class="left-num border">08</i>
                                        <h4>O que fazer quando troco o nome de usuário e/ou senha da minha marca no Instagram?</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>
                                ...
                                <div class="accordion accordion-block">
                                    <div class="accord-btn">
                                        ...
                                        <h4>Quantos seguidores por plano eu posso ganhar diariamente??</h4>
                                    </div>
                                    <div class="accord-content">
                                        <p>
