                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-6 col-xs-12">
                            <div class="right-img">
                                <figure>
                                    <img src="<?php echo base_url().'assets/'?>images/callto-action/woman-contact-us-2.jpg" style="margin-top:-50px;max-height: 450px" alt="callto action">
                                </figure>
                            </div>
                        </div>
