...
$config['business-node-class'] = getcwd() . '/application/business/Node.php';
...
$config['business-response-client-id-class'] = getcwd() . '/application/business/Response/ResponseClientId.php';
$config['business-response-array-object-class'] = getcwd() . '/application/business/Response/ResponseArrayObject.php';
