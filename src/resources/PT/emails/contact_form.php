...
<div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
  ...
  <p style="font-style: italic; font-size: 13px;">"<?php echo $_GET["message"]; ?>"</p>
  <br>
  <p>User personal contact information:</p>
  <p>email -> <strong><?php echo $_GET["useremail"]; ?></strong></p>
  <p>company -> <strong><?php echo $_GET["company"]; ?></strong></p>
  <p>phone -> <strong><?php echo $_GET["phone"]; ?></strong></p>
  <br>
  <p>DUMBU SYSTEM</p>
</div>
</body>
